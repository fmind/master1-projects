...
public class NodeTest {
    ...
    public void testFindByTarget() {
        ...
        // find by name
        assertEquals(1, barbara.findByTargetName("Social Graph").size());
    ...
    public void testFindByLink() {
        ...
        // by name
        assertEquals(3, barbara.findByLink("friend").size());
        assertEquals(1, barbara.findByLink("employee_of").size());
        assertEquals(0, barbara.findByLink("no").size());
        // by direction
