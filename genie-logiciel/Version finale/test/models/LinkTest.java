...
public class LinkTest {
    ...
    public void testFromString() {
        System.out.println("Link.fromString");
                        
        assertEquals(new Link("likes", Direction.OUT), Link.fromString("likes>"));
        assertEquals(new Link("author", Direction.IN), Link.fromString("author<"));
        assertEquals(new Link("friends", Direction.BOTH), Link.fromString("friends"));
        assertEquals(new Link("<d><u><m>p", Direction.BOTH), Link.fromString("<d><u><m>p"));
        assertEquals(new Link("category", Direction.ALL), Link.fromString("category*"));
    }
}